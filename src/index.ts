// import {Farm, Cow, SmallTrailer, Family, Truck, Person, Cat, Sheep, FarmWithLocation} from './classes'

// //Declarations.  Create two farms, a family, a small animal, and a vehicle.
// const OldMcDonald = new Farm()
// const SecondFarm = new FarmWithLocation()
// SecondFarm.location = "Farm"
...
// let kitty = new Cat("Kitty!", person1)
